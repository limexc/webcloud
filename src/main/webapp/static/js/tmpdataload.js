...
layui.define("layer", function(e) {
    ...
    p.prototype.config = {
        ...
        (o.hasClass(u) || o.hasClass(c)) && o.remove(), a.ie && a.ie < 10 && i.elem.wrap(
            ...
            .elem[0].name) : i.elem.after(n), a.ie && a.ie < 10 && e.initIE()
        ...
        t("#" + f)[0] || t("body").append(n), i.elem.next().hasClass(c) || (e.elemFile.wrap(a), i.elem.next(
            "." + c).append(function() {
            var e = [];
        ...
        var n, o = this,
            ...
            u = function() {
                var i = 0,
                    ...
                    u = function() {
                        l.multiple && i + n === o.fileLength && "function" == typeof l.allDone && l
                    .allDone({
                            total: o.fileLength,
                            successful: i,
                            aborted: n
        ...
        var e = this,
            ...
            l = function(t, n) {
                var a = e.elemFile,
                    o = t.length > 1 ? t.length + "个文件" : (t[0] || {}).name || a[0].value.match(
                        /[^\/\\]+\..+/g) || [] || "";
                a.next().hasClass(s) && a.next().remove(), e.upload(null, "choose"), e.isFile() || i
